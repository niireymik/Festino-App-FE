<template>
  <div class="relative">
    <div class="w-full h-[260px] sm:max-h-[295px] bg-booth-banner bg-no-repeat bg-cover z-1">
      <i
      ...
      <div class="absolute w-auto h-auto dynamic-top dynamic-padding">
        ...
        <div
          class="banner-title-shadow bg-gradient-to-b from-white from-50% to-primary-300 bg-clip-text text-transparent font-jalnan2 text-md sm:text-[19px]"
        >
          티노와 함께
        </div>
        <div
          class="banner-title-shadow bg-gradient-to-b from-white from-50% to-primary-300 bg-clip-text text-transparent font-jalnan2 text-3xl sm:text-[32px]"
        >
          축제 부스 알아보기
        </div>
      </div>
